        ...
        <section className="border-b border-border">
          <div className="container py-5">
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-5">
              ...
              >
                <div className="aspect-[16/9] bg-muted relative">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5">
                    <span className="category-pill bg-alert text-alert-foreground text-[10px] mb-2">
                      {navSections.find((s) => s.slug === featuredPost.section)?.title || "News"}
                    </span>
                    <h2 className="article-headline text-xl md:text-2xl text-white mt-2 line-clamp-3 group-hover:underline decoration-1 underline-offset-2">
                      {featuredPost.title}
                    </h2>
              ...
              {/* Right column: 4 smaller stories in 2x2 grid */}
                    ...
                    >
                      <div className="aspect-[16/10] bg-muted relative">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-3">
                          ...
                          <h3 className="text-sm font-bold text-white leading-tight mt-0.5 line-clamp-2 group-hover:underline decoration-1 underline-offset-2">
                            {post.title}
                          </h3>
                        </div>
                      </div>
                ...
                <div className="space-y-3">
                  {mediaItems.slice(0, 4).map((item) => (
                    <Link
                      ...
                      className="group flex gap-3"
                    >
                      <div className="w-28 h-20 bg-muted rounded-sm shrink-0 overflow-hidden">
                        {item.thumbnail && (
                          <img
                            src={item.thumbnail}
                            alt={item.title}
