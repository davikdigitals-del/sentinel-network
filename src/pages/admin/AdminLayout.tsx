...
import {
  LayoutDashboard, FileText, FolderTree, AlertTriangle, Upload, Menu, X,
  ChevronRight, Shield, Video, FileStack, LogOut, BookOpen, Library, Megaphone,
} from "lucide-react";
    ...
    <div className="min-h-screen flex bg-muted/30">
      ...
      <aside className={cn(
        ...
        <div className="p-4 border-t border-border space-y-2">
          <Link to="/" className="text-xs text-muted-foreground hover:text-foreground transition-colors block">← Back to public site</Link>
